...
import { PERMUTATION_PSEUDOCODE, SUBSET_PSEUDOCODE, permutation, subset, validatePermutation, validateSubset } from "./backtracking";
import {
...
export const GENERATORS: Record<VisualizationGeneratorKey, GeneratorDefinition> = {
  ...
  "deque-basic": {
    key: "deque-basic",
    inputHint: '[명령 목록] 예: [["push_back 1", "push_front 2", "pop_back"]] — push_front x / push_back x / pop_front / pop_back',
