...
import { GRAPH_REPRESENTATION_CARDS, GRAPH_REPRESENTATION_QUIZ } from "@/content/concepts/graph-representation";
...
export const graphRepresentationTopic: Topic = {
  ...
  concept: defineConcept("graph-representation", {
    cards: GRAPH_REPRESENTATION_CARDS,
    recognitionQuiz: GRAPH_REPRESENTATION_QUIZ,
  }),
