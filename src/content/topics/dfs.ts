...
export const dfsTopic: Topic = {
  ...
  levels: defineLevels("dfs", [
    ...
    { title: "그래프 DFS 구현", goal: "재귀와 스택 두 가지 방식으로 DFS와 방문 처리를 구현해요.", problemSlugs: [] },
    {
      title: "연결 요소 세기",
      goal: "격자와 그래프에서 이어진 덩어리를 찾아 개수와 크기를 셀 수 있어요.",
      problemSlugs: ["dfs-flower-zones"],
    },
    { title: "경로와 사이클 찾기", goal: "경로 존재 여부와 순환을 DFS로 판별해요.", problemSlugs: [] },
    {
      title: "트리 DFS 응용",
