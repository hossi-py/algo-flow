  ...
  levels: defineLevels("dfs", [
    {
      ...
      problemSlugs: ["dfs-cave-order", "dfs-power-restore"],
    },
    {
      title: "그래프 DFS 구현",
      goal: "재귀와 스택 두 가지 방식으로 DFS와 방문 처리를 구현해요.",
      problemSlugs: ["dfs-maze-escape", "dfs-club-count"],
    },
    {
      title: "연결 요소 세기",
      goal: "격자와 그래프에서 이어진 덩어리를 찾아 개수와 크기를 셀 수 있어요.",
      problemSlugs: ["dfs-flower-zones", "dfs-radio-network"],
    },
    {
      title: "경로와 사이클 찾기",
      goal: "경로 존재 여부와 순환을 DFS로 판별해요.",
      problemSlugs: ["dfs-recipe-loop", "dfs-downhill-routes"],
    },
    {
      title: "트리 DFS 응용",
      goal: "서브트리 크기·깊이 계산처럼 트리를 DFS로 다루는 실전 문제를 풀어요.",
      problemSlugs: ["dfs-team-size", "dfs-farthest-villages"],
    },
  ]),
