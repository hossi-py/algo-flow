...
export const DFS_CARDS: ConceptCard[] = [
  {
    ...
    keyPoints: ["깊이 먼저, 막히면 돌아오기", "재귀 호출 스택이 '돌아올 곳'을 기억해 줘요", "모든 곳을 한 번씩 방문하는 데 좋아요"],
  },
  {
    id: "dfs-visited",
    title: "방문 표시가 핵심이에요",
...
export const DFS_QUIZ: RecognitionQuestion[] = [
  {
    ...
    explanation: "이어진 덩어리(연결 요소)를 세는 대표 유형이에요. 땅 하나에서 DFS로 닿는 칸을 모두 칠하면 섬 하나가 끝나요. (BFS로도 풀 수 있어요)",
  },
  {
    id: "dfs-q2",
    snippet: "컴퓨터들의 연결 정보가 주어져요. 1번 컴퓨터가 바이러스에 걸렸을 때, 연결을 타고 감염되는 컴퓨터는 몇 대인가요?",
