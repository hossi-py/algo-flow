...
export const TOPIC_VISUALIZATIONS: Record<TopicSlug, VisualizationPreset[]> = {
  ...
  dijkstra: [
    preset(
      ...
      "dijkstra-basic",
      "가장 가까운 곳부터 확정하기",
      "힙에서 가장 가까운 노드를 꺼내 거리를 확정하고, 그 이웃으로 가는 길이 더 짧아지면 거리를 줄여요.",
      [
        5,
        [
          [0, 1, 4],
    ...
    preset(
      ...
      "dijkstra-path",
      "지나온 길 되짚기",
      "거리를 줄일 때 어디서 왔는지(prev)를 적어 두면, 도착점에서 거꾸로 따라가 경로를 만들 수 있어요.",
      [
        5,
        [
          [0, 1, 2],
    ...
    preset(
      ...
      "dijkstra-grid",
      "칸마다 비용이 다른 격자",
      "칸을 노드, 이웃 칸을 간선으로 보면 격자도 그래프예요. 들어가는 칸의 비용이 곧 간선 비용이에요.",
      [
        [
          [1, 3, 1],
          [1, 5, 1],
  ...
  "graph-advanced": [
    preset(
      ...
      "uf-union",
      "그룹 합치고 대표 찾기",
      "대표를 따라 올라가 같은 그룹인지 확인하고, 작은 그룹을 큰 그룹 밑에 붙여요. 지나온 노드는 대표를 바로 가리키게 줄여요.",
      [
        6,
        [
          [0, 1],
    ...
    preset(
      ...
      "mst-kruskal",
      "싼 간선부터 잇기 (크루스칼)",
      "비용이 싼 간선부터 보며, 이미 같은 그룹인 두 노드를 잇는 간선은 고리가 생기니 건너뛰어요.",
      [
        5,
        [
          [0, 1, 4],
    ...
    preset(
      ...
      "topo-kahn",
      "먼저 할 일부터 줄 세우기",
      "들어오는 화살표가 없는 일부터 꺼내고, 꺼낼 때마다 나가는 화살표를 지워요. 새로 0이 된 일을 큐에 넣어요.",
      [
        6,
        [
          [0, 2],
