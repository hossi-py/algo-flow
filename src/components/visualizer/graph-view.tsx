...
const NODE_STYLE: Record<
  GraphNodeStatus,
  { fill: string; stroke: string; text: string; dash?: string; label: string }
> = {
    ...
    <section className="flex min-w-0 flex-col gap-2 rounded-lg border border-border/70 bg-card/70 p-3">
      ...
      >
        ...
        <li className="inline-flex items-center gap-1">
          <span
            className="inline-grid size-3 place-items-center rounded-full bg-warning text-[8px] font-bold text-warning-foreground"
            aria-hidden
          >
            1
          </span>
