      ...
      <dl className="grid grid-cols-[auto_minmax(0,1fr)] gap-x-3 gap-y-1">
        {entries.map(([key, value]) => (
          <div key={key} className="contents">
            ...
            <dd className="font-mono text-code-sm font-semibold break-all text-foreground">{formatValue(value, 240)}</dd>
          </div>
        ))}
      </dl>
    </section>
          ...
          return (
            <li
              ...
              className={cn(
                ...
                active ? "border-primary-strong bg-primary-soft font-bold text-primary-soft-foreground" : "border-transparent",
              )}
            >
