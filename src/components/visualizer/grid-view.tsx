              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isChecking && "outline-2 outline-offset-1 outline-dashed outline-primary-strong",
                  )}
                >
                  ...
                  {isCursor && (
                    <Footprints className="absolute -top-1.5 -left-1.5 size-4 rounded-full bg-card p-0.5 text-primary-strong shadow-soft" aria-hidden />
                  )}
                  {CheckIcon && (
                    <CheckIcon
                      className={cn(
